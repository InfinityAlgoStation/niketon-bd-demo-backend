...
const createCows = (0, catchAsync_1.default)((req, res) =>
...
const getAllCows = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield cow_service_1.CowService.getAllCowsFromDB(
      filters,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
...
const updateCow = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const id = req.params.id;
    const result = yield cow_service_1.CowService.updateCowToDB(
      id,
      updatedCowData
    );
    (0, sendResponse_1.default)(res, {
