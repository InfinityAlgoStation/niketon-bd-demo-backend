...
const getAllUsers = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      users_constant_1.userFilterableFields
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      paginationFields_1.paginationFields
    );
    const result = yield users_service_1.UserService.getAllUsersFromDB(
      filters,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
...
const updateUser = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield users_service_1.UserService.updateUserToDB(
      id,
      updatedData
    );
    (0, sendResponse_1.default)(res, {
